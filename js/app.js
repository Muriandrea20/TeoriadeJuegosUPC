...
let crearEjemplos = (Filas, Columnas, Elementos, Cabeceras) => {
    ...
    document.getElementById('#btn-Nash-dominadas').addEventListener('click', () => {
        botonDominadas(table, filas, columnas)
    });

    // LLAMADA AL EVENTO BOTÓN PURAS
    document.getElementById('#btn-Nash-Pura').addEventListener('click', () => {
        botonPuras(table, columnas, estilosInputs);
    });

    // LLAMADA AL EVENTO BOTÓN MIXTAS
    document.getElementById('#btn-Nash-Mixta').addEventListener('click', () => {
        botonMixtas(table, filas, columnas);
    });

    // LLAMADA AL EVENTO BOTÓN EVOLUTIVAS
    document.getElementById('#btn-Nash-Ecolutiva').addEventListener('click', () => {
...
document.getElementById('dilemaPrisionero').addEventListener('click', () => {
    ...
    elementos[0][0] = new CElemento(-1, -1);
    elementos[0][1] = new CElemento(-10, 0);
    elementos[1][0] = new CElemento(0, -10);
    elementos[1][1] = new CElemento(-5, -5);
    ...
    Cabeceras[1][0] = 'CALLA';
    Cabeceras[1][1] = 'CONFIESA';
    Cabeceras[0][0] = 'CALLA';
    Cabeceras[0][1] = 'CONFIESA';
...
document.getElementById('batallaSexos').addEventListener('click', () => {
    ...
    elementos[0][0] = new CElemento(1, 2);
    elementos[0][1] = new CElemento(0, 0);
    elementos[1][0] = new CElemento(0, 0);
    elementos[1][1] = new CElemento(2, 1);
    ...
    Cabeceras[1][0] = 'BOXEO';
    Cabeceras[1][1] = 'COMPRAS';
    Cabeceras[0][0] = 'BOXEO';
    Cabeceras[0][1] = 'COMPRAS';
...
document.getElementById('piedraPapelTijera').addEventListener('click', () => {
    ...
    elementos[0][0] = new CElemento(-25,0);
    elementos[0][1] = new CElemento(0,0);
    elementos[1][0] = new CElemento(25,0);
    elementos[1][1] = new CElemento(50,0);

    let Cabeceras = [];
    for (let i = 0; i < 3; ++i) {
        Cabeceras[i] = [];
    }
    Cabeceras[1][0] = 'PALOMA';
    Cabeceras[1][1] = 'PALOMA';
    Cabeceras[0][0] = 'HALCÒN';
    Cabeceras[0][1] = 'HALCÒN';
